 ...
 */
public class LSDefaultCommunicationAdapterFactory
    implements VehicleCommAdapterFactory {

  /**
   * The adapter components factory.
   */
  private final LSDefaultAdapterComponentsFactory adapterFactory;
  /**
   ...
   */
  @Inject
  public LSDefaultCommunicationAdapterFactory(LSDefaultAdapterComponentsFactory componentsFactory) {
  ...
  public VehicleCommAdapterDescription getDescription() {
    return new LSDefaultCommunicationAdapterDescription();
  }
  ...
  @Override
  public LSDefaultCommAdapter getAdapterFor(Vehicle vehicle) {
    requireNonNull(vehicle, "vehicle");
    return adapterFactory.createLSDefaultCommAdapter(vehicle);
  }
}
